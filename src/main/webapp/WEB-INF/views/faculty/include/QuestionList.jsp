		...
		<div class="card mb-12 widget-content bg-white-smile">
			<div class="widget-content-wrapper text-black">
				<div class="widget-content-left">
					<a
						href='<spring:url value="/faculty/question_ans?qid=${questions.id}"/>'><div
				...
				<div class="widget-content-right">
					...
					<div class="widget-numbers text-black">
						<a
						href='<spring:url value="/faculty/inc_que_like?qid=${questions.id}"/>'><i class='fa fa-heart' style='color: ${requestScope.iconHeart}'></i> </a><span>Likes
