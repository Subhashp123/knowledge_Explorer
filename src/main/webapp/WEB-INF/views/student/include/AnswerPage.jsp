			...
			<div class="card text-black" style="border-radius: 25px;">
				<div class="card-body p-md-5">
					...
					<div class="col-md-10 col-lg-12">
						<div class="row">
							<div class="col col-lg-12 mb-4">
								<div class="form-outline flex-fill mb-0">
									<label class="form-label"><h3>Answers to your
						...
						<a
						href='<spring:url value="/student/inc_ans_like?aid=${ans.id}&qid=${sessionScope.Question.id}"/>'><i class='fa fa-heart' style='color: red'></i> </a><span>Likes
							${ans.likes}</span>
					</div>
										</div>
									</div>
